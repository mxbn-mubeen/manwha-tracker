...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-start gap-1 overflow-x-auto rounded-md bg-[#0e0f11] p-1 text-zinc-500 border border-border/30 [&::-webkit-scrollbar]:hidden sm:inline-flex sm:w-auto sm:justify-center',
      className
    )}
